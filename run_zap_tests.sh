...
sbt -Dsecurity.assessment=true -Denvironment=local clean 'testOnly uk.gov.hmrc.test.api.specs.*' || TEST_FAILED=true
...
browse ./dast-config-manager/target/dast-reports/index.html
